...
/**
 * This class returns build information about Cortara components.
 */
public class VersionInfo {
	...
	/**
	 * Get the Cortara version.
	 *
	 * @return the Cortara version string, eg. "0.6.3-dev"
	 */
	...
	/**
	 * The date that Cortara was compiled.
	 *
	...
	/**
	 * The user that compiled Cortara.
	 *
	...
	/**
	 * Get the subversion URL for the root Cortara directory.
	 */
	...
	/**
	 * Get the checksum of the source files from which Cortara was
	 * built.
	 **/
	...
	public static void main(String[] args) {
		...
		System.out.println("Cortara " + getVersion());
