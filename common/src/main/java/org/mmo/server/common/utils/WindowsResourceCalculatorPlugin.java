...
@Private public class WindowsResourceCalculatorPlugin extends ResourceCalculatorPlugin {
	...
	String getSystemInfoInfoFromShell() {
		ShellCommandExecutor shellExecutor = new ShellCommandExecutor(new String[] { Shell.WINUTILS, "systeminfo" });
		try {
